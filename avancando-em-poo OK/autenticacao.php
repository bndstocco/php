...
$umDiretor = new \Alura\Banco\Modelo\Funcionario\Gerente( // Cria uma instância de um Diretor (ou Gerente, dependendo do nome correto da classe)
    'João da Silva', // Define o nome do diretor/gerente
    new CPF('123.456.789-10'), // Define um CPF para o diretor/gerente
    10000 // Define o salário do diretor/gerente
);

$autenticador->tentaLogin($umDiretor, '4321'); // Tenta realizar o login com o diretor/gerente usando a senha '4321'
