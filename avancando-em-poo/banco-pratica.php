...
$vinicius = new Titular (new CPF('038.928.540-41'), 'Bnd stocco', $endereco); // Instancia um objeto Titular
...
echo $primeiraConta->recuperaCpfTitular() . PHP_EOL;// Exibe o nome do titular da primeira conta
...
$patricia = new Titular(new CPF('038.928.540-41'), 'Patricia', $endereco);// Instancia um novo objeto Titular para Patricia
...
$outra = new ContaCorrente(new Titular(new CPF('038.928.540-41'), 'Abcdef', $outroEndereco));// Instancia uma nova ContaCorrente com um titular diferente
